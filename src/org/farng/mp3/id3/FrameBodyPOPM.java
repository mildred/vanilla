...
public class FrameBodyPOPM extends AbstractID3v2FrameBody {
     ...
     * Creates a new FrameBodyPOPM object.
     */
    public FrameBodyPOPM(final RandomAccessFile file, AbstractID3 parent) throws IOException, InvalidTagException {
    ...
    static protected TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("POPM");
    public TagIdentifier getIdentifier() {
        return IDENTIFIER;
    }

    public String getClassIdentifier() {
        return IDENTIFIER.toString() + ((char) 0) + getEmailToUser();
    }
