...
public class FrameBodyTMED extends AbstractFrameBodyTextInformation {
     ...
     * Creates a new FrameBodyTMED object.
     */
    public FrameBodyTMED(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("TMED");
