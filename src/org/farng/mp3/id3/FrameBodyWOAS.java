...
public class FrameBodyWOAS extends AbstractFrameBodyUrlLink {
     ...
     * Creates a new FrameBodyWOAS object.
     */
    public FrameBodyWOAS(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("WOAS");
