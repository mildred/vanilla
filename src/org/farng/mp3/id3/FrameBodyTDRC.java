...
public class FrameBodyTDRC extends AbstractFrameBodyTextInformation {
     ...
     * Creates a new FrameBodyTDRC object.
     */
    public FrameBodyTDRC(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("TDRC");
