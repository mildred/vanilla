...
public class FrameBodyMCDI extends AbstractID3v2FrameBody {
     ...
     * Creates a new FrameBodyMCDI object.
     */
    public FrameBodyMCDI(final RandomAccessFile file, AbstractID3 parent) throws IOException, InvalidTagException {
        this.read(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("MCDI");
