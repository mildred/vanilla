...
public class FrameBodyTPRO extends AbstractFrameBodyTextInformation {
     ...
     * Creates a new FrameBodyTPRO object.
     */
    public FrameBodyTPRO(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("TPRO");
