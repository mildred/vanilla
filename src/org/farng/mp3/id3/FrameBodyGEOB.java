...
public class FrameBodyGEOB extends AbstractID3v2FrameBody {
     ...
     * Creates a new FrameBodyGEOB object.
     */
    public FrameBodyGEOB(final RandomAccessFile file, AbstractID3 parent) throws IOException, InvalidTagException {
    ...
    static protected TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("GEOB");
