...
public class FrameBodyTDLY extends AbstractFrameBodyTextInformation {
     ...
     * Creates a new FrameBodyTDLY object.
     */
    public FrameBodyTDLY(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("TDLY");
