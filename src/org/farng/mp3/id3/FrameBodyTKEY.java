...
public class FrameBodyTKEY extends AbstractFrameBodyTextInformation {
     ...
     * Creates a new FrameBodyTKEY object.
     */
    public FrameBodyTKEY(final RandomAccessFile file, AbstractID3 parent) throws java.io.IOException, InvalidTagException {
        super(file, parent);
    }

    static protected final TagFrameIdentifier IDENTIFIER = TagFrameIdentifier.get("TKEY");
